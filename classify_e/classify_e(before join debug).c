...
/*参数设定*/
#define Defense_C_IP "::1"   //30所Defense_C的IP
#define Defense_C_Port 8888  //30所Defense_C的端口号
#define DATABASE_IP "2001:da8:1002:5033:20c:29ff:fe0f:1a7e"  //DDoS离线流程数据库IP地址
...
void sendDdosResult(int ddosType)
{
    ...
    int addr_len;  
    char msg[3];  //msg[0]:DDoS攻击类型; msg[1]:报文类型0x12; msg[2]:EGP_ID
